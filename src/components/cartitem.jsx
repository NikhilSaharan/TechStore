...
const cartitem = (props) => {
    ...
    const { addToCart, cartItems, removeFromCart, updateCartItemCount, itemPrice} = useContext(ShopContext);
        ...
        <div className="col-12 col-md-7">
          ...
          <div className="p-3 d-flex justify-content-between align-items-center">
            <div className="count-handler">
              ...
              <button className="btn btn-outline-secondary" onClick={() => removeFromCart(id)}>-</button>
            </div>
